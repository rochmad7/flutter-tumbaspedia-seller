...
const String prosesPesanan = "Langkah-langkah proses pesanan:\n\n" +
    ...
    "5. Setelah pesanan sampai di tangan pembeli, pembeli mengubah status pesanan menjadi \"Pesanan telah diterima\".\n\n" +
...
const String statusPesanan = 'Status pesanan Anda dapat diubah dengan kesepakatan penjual. Berikut adalah beberapa status yang mungkin terjadi:\n\n' +
    ...
    '3. Pesanan sedang diproses/pengiriman: Status pesanan setelah kesepakatan antara pembeli dan penjual tercapai, dan penjual mulai memproses pesanan dan dalam proses pengiriman.\n\n' +
    '4. Pesanan selesai: Status akhir untuk penjual setelah pesanan telah diterima oleh pembeli dan pembeli mengkonfirmasi penerimaan barang melalui tombol "Terima pesanan" pada detail pesanan dengan status "Pesanan sedang diproses/pengiriman".';

const String tandaMerah =
    "Tanda notifikasi berwarna merah pada aplikasi Tumbaspedia menunjukkan bahwa terdapat pesanan baru yang masuk untuk penjual. Setelah menerima notifikasi tersebut, penjual dapat memproses pesanan sesuai dengan kebutuhan. Pastikan untuk selalu memeriksa notifikasi secara berkala agar tidak melewatkan pesanan baru.";
