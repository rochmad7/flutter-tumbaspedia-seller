...
List<Privacy> mockPrivacy = [
  ...
  Privacy(
    ...
    text:
        "Doltinuku tidak menjual, membagi atau memperjualbelikan informasi pribadi pelanggan yang dikumpulkan secara online melalui pihak ketiga. Informasi pribadi yang dikumpulkan online hanya akan dibagi di dalam perusahaan kami hanya untuk kepentingan internal. Informasi pribadi yang kami kumpulkan, ketika Anda membuat akun di Doltinuku adalah:\n- Nama\n- Alamat Email\n- Nomor Telepon.\n- Alamat Anda\n\nInformasi pribadi yang kami kumpulkan dari Anda akan digunakan untuk hal-hal seperti:\n- Untuk menginformasikan Anda kepada pemilik toko UKM\n- Untuk memberikan informasi produk kami\n- Untuk memberikan layanan dan informasi yang ditawarkan situs kami dan yang telah Anda minta",
  ),
  Privacy(
    id: 4,
    title: "Memperbarui Informasi Pribadi Anda",
    text:
        "Anda dapat memperbarui informasi pribadi Anda kapan saja dengan mengakses akun Doltinuku Anda di aplikasi.",
  ),
  Privacy(
    id: 5,
    title: "Keamanan Informasi Pribadi Anda",
    text:
        "Doltinuku memastikan bahwa semua informasi yang dikumpulkan akan disimpan dengan aman. Kami melindungi semua informasi pribadi Anda dengan:\n- Membatasi akses terhadap informasi pribadi\n- Mengikuti kemajuan teknologi pengamanan untuk mencegah akses komputer tidak sah menghapus data pribadi Anda yang tidak dibutuhkan lagi untuk kepentingan dokumentasi kami.",
  ),
  Privacy(
    id: 6,
    title: "Pembukaan Informasi Pribadi",
    text:
        "Kami tidak akan membagi informasi Anda dengan organisasi lainnya, selain kepada pihak toko UKM yang berhubungan dan pihak ketiga yang berhubungan langsung dengan pembelian produk yang Anda beli dari aplikasi Doltinuku",
  ),
  Privacy(
    id: 7,
    title: "Perubahan pada Kebijakan Privasi",
    text:
        "Doltinuku memiliki hak untuk mengganti dan mengubah Pernyataan Privasi pada waktu kapan saja. Semua perubahan kebijakan akan diumumkan di situs kami.",
  ),
];
